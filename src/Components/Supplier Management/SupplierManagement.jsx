...
export default function Measurment() {
  ...
  const [newRowData, setNewRowData] = useState({ supplierName: '', location: '', keyProduct: '', sustainabilityScore: ''});
  ...
  const handleClosePopup = () => {
    ...
    setNewRowData({supplierName: '', location: '', keyProduct: '', sustainabilityScore: '' });
  };
